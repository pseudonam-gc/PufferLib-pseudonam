...
import pufferlib
from pufferlib.ocean.threes import binding

class Threes(pufferlib.PufferEnv):
    def __init__(self, num_envs=1, reward_scaler=1.0,
        ...
        self.single_observation_space = gymnasium.spaces.Box(
            low=0, high=100, shape=(16*18 + 8,), dtype=np.uint8  # grid + bag(4) + next_box_onehot(1)
        )"""
        self.single_observation_space = gymnasium.spaces.Box(
            low=0,
            high=17,
