...
def main():
    ...
    base_policy = Threes(MockEnv(), hidden_size=1024, one_hot=True)
    ...
    # Load checkpoint
    checkpoint = torch.load('../../../experiments/puffer_threes_jd2oel3q.pt', map_location='cpu')
    ...
    obs = torch.tensor([[0, 1, 2, 3, 3, 0, 1, 2, 0, 0, 3, 0, 1, 2, 0, 0, 4, 4, 4, 12, 1, 0, 0, 0]], dtype=torch.long)
    ...
    dummy_obs = torch.zeros(1, 24, dtype=torch.long)
